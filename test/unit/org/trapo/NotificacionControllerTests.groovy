...
class NotificacionControllerTests {
    ...
    def populateValidParams(params) {
        ...
        def fecha1 = new Date().parse("yyyy/MM/dd", "2010/03/18")
        def fecha2 = new Date().parse("yyyy/MM/dd", "2010/03/20")

        def adm = new Administrativo(
            numeroEmpleado: 4,
            supervisor : null,
            nombre : "admin",
            apellidos : "istrativo",
        ...
        params["nombre"] = 'Noticia'
        params["descripcion"] = 'Estoy probado esto'
        params["periodoInicial"] = fecha1
        params["periodoFinal"] = fecha2
        params["planificador"] = adm
