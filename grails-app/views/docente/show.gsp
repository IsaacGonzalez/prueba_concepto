	...
	<body>
		...
		<div id="show-docente" class="content scaffold-show" role="main">
			...
			<ol class="property-list docente">
				...
				<g:if test="${docenteInstance?.correo}">
				<li class="fieldcontain">
					<span id="correo-label" class="property-label"><g:message code="docente.correo.label" default="Correo" /></span>
					
						<span class="property-value" aria-labelledby="correo-label"><g:fieldValue bean="${docenteInstance}" field="correo"/></span>
