	...
	<body>
		...
		<div id="show-coordinadorArea" class="content scaffold-show" role="main">
			...
			<ol class="property-list coordinadorArea">
				...
				<g:if test="${coordinadorAreaInstance?.correo}">
				<li class="fieldcontain">
					<span id="correo-label" class="property-label"><g:message code="coordinadorArea.correo.label" default="Correo" /></span>
					
						<span class="property-value" aria-labelledby="correo-label"><g:fieldValue bean="${coordinadorAreaInstance}" field="correo"/></span>
