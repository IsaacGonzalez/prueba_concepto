			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="correo" title="${message(code: 'coordinadorArea.correo.label', default: 'Correo')}" />
				...
				<g:each in="${coordinadorAreaInstanceList}" status="i" var="coordinadorAreaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${coordinadorAreaInstance.id}">${fieldValue(bean: coordinadorAreaInstance, field: "correo")}</g:link></td>
