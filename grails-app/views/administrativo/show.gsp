	...
	<body>
		...
		<div id="show-administrativo" class="content scaffold-show" role="main">
			...
			<ol class="property-list administrativo">
				...
				<g:if test="${administrativoInstance?.correo}">
				<li class="fieldcontain">
					<span id="correo-label" class="property-label"><g:message code="administrativo.correo.label" default="Correo" /></span>
					
						<span class="property-value" aria-labelledby="correo-label"><g:fieldValue bean="${administrativoInstance}" field="correo"/></span>
