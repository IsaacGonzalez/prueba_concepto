	...
	<body>
		...
		<div id="show-coordinadorCarrera" class="content scaffold-show" role="main">
			...
			<ol class="property-list coordinadorCarrera">
				...
				<g:if test="${coordinadorCarreraInstance?.correo}">
				<li class="fieldcontain">
					<span id="correo-label" class="property-label"><g:message code="coordinadorCarrera.correo.label" default="Correo" /></span>
					
						<span class="property-value" aria-labelledby="correo-label"><g:fieldValue bean="${coordinadorCarreraInstance}" field="correo"/></span>
