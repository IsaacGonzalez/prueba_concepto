			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="correo" title="${message(code: 'coordinadorCarrera.correo.label', default: 'Correo')}" />
				...
				<g:each in="${coordinadorCarreraInstanceList}" status="i" var="coordinadorCarreraInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${coordinadorCarreraInstance.id}">${fieldValue(bean: coordinadorCarreraInstance, field: "correo")}</g:link></td>
